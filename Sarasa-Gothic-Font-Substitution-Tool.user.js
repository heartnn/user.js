...
const FONT_FAMILY_TYPE = {
  generic: "var(--icon-font-family), var(--generic-font-family),icomoon,iconfont,brand-icons,FontAwesome,genericons,Inconsolata,'Material Icons','Material Icons Extended','Glyphicons Halflings',dzicon,system-ui;",
